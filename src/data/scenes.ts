...
export const scenes: Scene[] = [
  ...
  { id: "bali-sunrise-house", name: "Bali Sunrise House", country: "Indonesia", city: "Ubud", location: "UBUD, BALI", timezone: "Asia/Makassar", weatherLocation: "Ubud, ID", coverImage: "/scenes/bali-sunrise-house/images/bali-sunrise-house.png", backgroundImage: "/scenes/bali-sunrise-house/images/bali-sunrise-house.png", ambientAudio: "/scenes/bali-sunrise-house/audio/morning-garden.mp3", seasonalAudio: "", description: "The day begins before the heat, before anyone needs you.", mood: "reset", weather: "23°C · First light", time: "6:02 AM", aiPrompt: "Write one short quiet observation from an Ubud sunrise house.", status: "available", discoveryTiming: "completion" },
