...
export const scenes: Scene[] = [
  ...
  { id: "norwegian-fjord-house", name: "Beyond the Fjord", country: "Norway", city: "Geiranger", location: "Geiranger, Norway", timezone: "Europe/Oslo", weatherLocation: "Geiranger, NO", coverImage: "/scenes/norwegian-fjord-house/images/norwegian-fjord-house.png", backgroundImage: "/scenes/norwegian-fjord-house/images/norwegian-fjord-house.png", ambientAudio: "/scenes/norwegian-fjord-house/audio/norwegian-cabin-soundscape.m4a", seasonalAudio: "", description: "Leave the noise on the other side.", mood: "escape", weather: "14°C · Quiet evening", time: "Golden hour", aiPrompt: "Write one short quiet observation from a Norwegian fjord house.", status: "available", motion: cinematicPushIn(1.02, 45), scenePresence: { timeOfDay: "Golden Hour", atmosphere: "Open Air · Still Fjord", whisper: "The world feels very far away." } },
  ...
  { id: "california-coastal-morning", name: "Above the Clouds", country: "United States", city: "Big Sur", location: "Big Sur, California", timezone: "America/Los_Angeles", weatherLocation: "Big Sur, US", coverImage: "/scenes/california-coastal-morning/images/california-coastal-morning.png", backgroundImage: "/scenes/california-coastal-morning/images/california-coastal-morning.png", ambientAudio: "/scenes/california-coastal-morning/audio/coastal-waves.m4a", seasonalAudio: "", description: "Some mornings change everything.", mood: "reset", weather: "18°C · Ocean mist", time: "7:36 AM", aiPrompt: "Write one short quiet observation from a California coast at morning.", status: "available", motion: cinematicPushIn(1.025, 45), scenePresence: { timeOfDay: "Early Morning", atmosphere: "Salt Air · Coastal Haze", whisper: "The day is beginning below you." } },
];
